...
class App(tk.Tk):
    ...
    def server_information(self) -> dict:
        # TODO: Add Refresh Icons to Server Information LabelFrame
    ...
    def select_item(self, event) -> bool:
        ...
        def make_buttons():
            ...
            self.screenshot_btn = Button(self.controller_btns, text="Screenshot", width=15,
                                         pady=5,
            ...
            self.last_restart_btn = Button(self.controller_btns, text="Last Restart", width=15,
                                           pady=5,
                                           command=lambda: self.last_restart(clientConn, ip,
                                                                             sname))
            ...
            self.update_client = Button(self.controller_btns, text="Update Client", width=15,
                                        pady=5,
            ...
            self.maintenance = Button(self.controller_btns, text="Maintenance", width=15,
                                      pady=5,
